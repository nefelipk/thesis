...
\begin{document}
	...
	Many authors use an extension of Markov chains, named Markov Decision Process 
	(\acronym{mdp}), to formulate the problem of autonomous navigation and allow 
	mobile robots to make decisions \cite{Wigness, Zhelo}. Others use Markov Random 
	Field (\acronym{mrf}) to i.e. enforce spatial consistency in a map or the 
	preference that neighboring points have the same label \cite{Lalonde} 
	(for additional information see \cite{Li}).
	\par
