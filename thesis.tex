...
\begin{document}
	...
	\begin{table}[h!]
		...
		\begin{tabular}{|c|c|c|c|}
			...
			\hline
		\end{tabular}
		\caption{Percentage of evaluation images that their traversability was found 
		correctly with the 1st calculating method.}
		\label{table:1st}
	\end{table}
	
	Even thought we think that the second calculating method is more representative of 
	the overall sample, in this case the first one gives better results. That is probably 
	because the non-traversable images of the training set are much more that the 
	traversable ones.
	...
	\begin{table}[h!]
		...
		\end{tabular}
		\caption{Percentage of evaluation images that their traversability was found 
		correctly with the 2nd calculating method.}
		\label{table:2nd}
	\end{table}
	...
	\begin{table}[h!]
		...
		\begin{tabular}{|c|c|c|}
			...
			\hline
		\end{tabular}
		\caption{Pyramid Scene Parsing Network - Percentage of evaluation images that their traversability was found correctly with the 1st and the 2nd calculating method.}
		\label{table:psp}
	\end{table}
