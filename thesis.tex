...
\begin{document}
	...
	\acronym{pascal voc} are shown in Figure~\ref{fig:fcn}.
	\par
	...
	\begin{table}[h!]
		...
		\begin{tabular}{|c|c|c|c|}
			\hline
			\multicolumn{4}{|c|}{2nd calculating method}\\
			\hline
			Fold & Success with \acronym{fcn} & Success with \acronym{psp} & Success with DeepLab\\ 
			\hline\hline
			1 & 54.6\% & 62.61\% & 54.6\%\\
	...
	In Table~\ref{table:psp} one can easily observe that fold 1 has the worst results 
	...
	In Table~\ref{table:dataset} one can find some of the available datasets 
