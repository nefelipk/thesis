...
\begin{document}
	...
	help in building robot applications. Using a tutorial \footnote[2]{ \url{http://wiki.ros.org/rosbag/Tutorials/Exporting\%20image\%20and\%20video\%20data}}
	on how to export image and video data from a bag file, we extract 778 
	...
	\par
	So in order to evaluate our model we split our data sample in five folds and perform 
	5-fold cross validation. Because we have twenty bag files, each fold has an equal 
	number of four bags. During each fold we use two traversable and two non-traversable 
	bag files for testing and the rest for training. In Table~\bl{\ref{table:folds_images}} 
