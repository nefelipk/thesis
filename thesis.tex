...
\begin{document}
	...
	\\
		...
		\todo[size={{\scriptsize}}]{Probably should say some more things about the previous models,
			VGG, AlexNet etc? Or the one we will use.. Maybe Tai? Sermanet? Hadsell?}
	...
	\todo[size={{\scriptsize}}]{Why can't we use Tai?}
	\todo[size={{\scriptsize}}]{Something like Sermanet or Hadsell?}
	...
	\todo[size={{\scriptsize}}]{COCO 2016 for object detection? SSD? YOLO?}
	COCO2016
