...
\begin{document}
	...
	connections and parameters and so they are easier to train \citep{Krizhevsky_alexnet}. 
	Also their theoretically-best performance is likely to be only slightly worse. 
	...
	And others, like MobileNet, SqueezeNet \citep{Howard_mobilenet, Iandola_squeezenet} 
