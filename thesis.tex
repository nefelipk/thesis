...
\begin{document}
	...
	traversability analysis methodologies in the past \cite{Papadakis}.
	\\
	...
	\todo[size={{\scriptsize}}]{Is this synthetic data?}
	...
	\todo[size={{\scriptsize}}]{Compare LIDAR and stereo camera sensory input. Is the intensity and wave information in LIDAR actually used?}
	...
	data, is necessary \cite{Suger, Lalonde}. \acronym{lidar} (also called \term{ladar} 
	\cite{Lalonde, Shneier}) is an acronym used for \term{light detection and 
	...
	pulses with a sensor. Differences in laser return times and wavelengths	
	...
	sensors, like fisheye camera \cite{Hirose, HiroseGonet}, 
	...
	dynamic environments. But they less interested in traversability 
	...
	provide information about the traversability of the terrain, they are 
