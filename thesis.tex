...
\begin{document}
	...
	Terrain \term{traversability analysis} has been used as a means for navigating 
	...
	achieving goals in an optimal mode of operation \cite{Papadakis}.
	\\
	...
	\term{occupancy grid maps} \cite{Moravec}. These are maps depicting the robot’s 
	environment with regions classified as empty, occupied or unknown. More 
	concrete, this occupancy information is projected onto a two-dimensional map.
	...
	non-traversable terrain \cite{Suger, Hirose, Wigness}. It also declares that one of the most popular and extensively used approaches 
