...
\begin{document}
	...
	\todo[size={{\scriptsize}}]{Also other papers mentioned below \& MAYBEs on papers file}
...
From On-Road to Off: Transfer Learning within a Deep Convolutional Neural Network for Segmentation and Classification of Off-Road Scenes (\url{https://www.youtube.com/watch?v=HfdoM9GJVAw})  ->  no available code -> {sky, water, dirt, paved road, grass, foliage, tree, and man-made obstacle}
