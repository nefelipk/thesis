...
\begin{document}
	...
	switch \cite{Kim}. This makes is possible to assess the progress of the robot 
	automatically. That way successes and failures of the navigation provide positive 
	and negative \term{traversability} examples. This kind of approaches can make 
	predictions about the \term{traversability} of the terrain based on the robot's 
	past experiences and navigation sensor values.
	\\
